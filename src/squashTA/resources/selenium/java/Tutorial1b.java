...
//	driver = new RemoteWebDriver("http://localhost:9515", DesiredCapabilities.chrome());
	baseUrl = parser.setServer("https://game-prodcopy.sw.co.ua/");
  ...
  public void testTutorial() throws Exception {
	...
	Thread.sleep(2000);
	  ...
	  for (int second = 0;; second++) {
			...
			if (isElementPresent(By.id("battleReg"))) break;
			Thread.sleep(1000);
		}
	  driver.findElement(By.id("battleReg")).click();
	  Thread.sleep(500);
	  driver.findElement(By.cssSelector(".buttonGlassLong>.value")).click();
	  Thread.sleep(15000);
/*	
