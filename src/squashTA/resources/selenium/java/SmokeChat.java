...
//    baseUrl = "https://www-uat.sw.co.ua/";
  ...
  public void testChat() throws Exception {
	  try {
		  ...
		  Report.WriteToLog("Send smile in chat");
		  
		  for (int second = 0;; second++) {
			  	if (second >= 60) fail("timeout");
			  	try { if (isElementPresent(By.id("messages"))) break; } catch (Exception e) {}
			  	Thread.sleep(1000);
			  }
		  
		  Thread.sleep(2000);
		  
		  driver.findElement(By.id("inputMsg")).clear();
		  driver.findElement(By.id("inputMsg")).sendKeys("");
		  
		  Thread.sleep(3000);
		  
		  driver.findElement(By.id("inputMsg")).sendKeys("123");
		  
		  Thread.sleep(2000);
		  
		  driver.findElement(By.id("smileBtn")).click();

		  Thread.sleep(2000);
		  
		  driver.findElement(By.cssSelector("#smilesChoose span.emo-good")).click();
		  
		  Thread.sleep(1000);
		  
		  driver.findElement(By.id("sendMsg")).click();
		    
		  Report.WriteToLog("Open info for last messenger");
		  
		  Thread.sleep(6000);
		  
		  driver.findElement(By.xpath("//div[@id='messagesWrap']/div[last()]/div[2]")).click();
		  
		  Thread.sleep(1000);
		  
		  driver.findElement(By.cssSelector("#information")).click();
		  
		  Report.WriteToLog("Check user-id");
		  
		  Thread.sleep(1000);
		  
		  for (int second = 0;; second++) {
			  	if (second >= 10) fail("timeout");
			  	try { if (isElementPresent(By.xpath("//div[@data-userid='5566fd05fe9857442b13043a']"))) break; } catch (Exception e) {}
			  	Thread.sleep(1000);
			  }
