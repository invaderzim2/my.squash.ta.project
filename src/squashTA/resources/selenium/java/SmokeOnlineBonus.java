...
//    baseUrl = "https://www-uat.sw.co.ua/";
  ...
  @Test
  public void testOnlineBonus() throws Exception {
	  try {

Thread.sleep(2000);

Report.WriteToLog("Wait for mini-profile");

for (int second = 0;; second++) {
	if (second >= 60) fail("timeout");
	try { if (isElementPresent(By.cssSelector("div.nickname"))) break; } catch (Exception e) {}
	Thread.sleep(1000);
}
...
for (int second = 0;; second++) {
	...
	try { if (isElementPresent(By.cssSelector("div.v-onlineBonus"))) break; } catch (Exception e) {}
	Thread.sleep(1000);
}
