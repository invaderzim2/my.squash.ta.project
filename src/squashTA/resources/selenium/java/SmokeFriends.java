...
//    baseUrl = "https://www-uat.sw.co.ua/";
  ...
  public void testFriends() throws Exception {
	  try {
		  ...
		  Report.WriteToLog("Open friends tab");
		  ...
		  Report.WriteToLog("Open \"players online\" tab");
		  ...
		  Report.WriteToLog("Find current player nickname");
		  
		  Thread.sleep(2000);

		  assertTrue(isElementPresent(By.xpath("//div[@data-name='Autotest']")));
