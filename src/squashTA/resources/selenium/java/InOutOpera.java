...
//	  WebDriver driver = new RemoteWebDriver(capabilities.opera);
//    WebDriver driver = new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"), DesiredCapabilities.opera());
//	System.setProperty("webdriver.opera.driver", "E:\\operadriver.exe");
//    WebDriver driver = new RemoteWebDriver(new URL("http://localhost:9515"), DesiredCapabilities.opera());
//	driver = new RemoteWebDriver();  
//  driver = new FirefoxDriver();
	System.setProperty("webdriver.chrome.driver", "E:\\operadriver.exe");
...
//	driver.get("http://www.google.com");
  ...
  @Test
  public void testInOutOpera() throws Exception {
